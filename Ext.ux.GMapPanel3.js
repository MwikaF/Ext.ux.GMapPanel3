...
/**
* @class Ext.ux.panel.GMapPanel3
* @extends Ext.Panel
* based on Ext.ux.GMapPanel by Shea Federick 
* adding map click events function by Yudhi Armyndharis
* @author Shea Frederick - http://www.vinylfox.com
* @author Yudhi Armyndharis - http://armyndharis.blogspot.com
* <p>Sample usage:</p>
* <pre><code>
...
Ext.ux.GMapPanel3 = Ext.extend(Ext.Panel, {
	...
	*/
    ...
    initComponent: function(){
		this.addEvents(
			...
			*/
			...
			/**
			* @event mapclick
			* Fires when the Google Maps is clicked
			*/
			'mapclick'
		);
		Ext.applyIf(this,{
    ...
    apiReady: function(){      
		if (this.rendered){(
			function(){
				...
				google.maps.event.addListener(this.getMap(), 'click', this.onMapClick.createDelegate(this));
	...
	onMapClick: function(){
		//console.log('map clicked');
		this.fireEvent('mapclick', this, this.getMap());
	},
	// private
